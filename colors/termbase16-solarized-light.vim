...
highlight clear
syntax reset
let g:colors_name="termbase16-solarized-light"
...
let s:t4="066" " Dark Foreground (Status bars)
let s:t5="242" " Default Foreground
let s:t6="236" " Light Foreground (Rarely used)
...
let s:tC="006" " Escapes, RegExp
let s:tD="032" " Function, Include, Directory
let s:tE="062" " Keywords, Storage, Diff Change
let s:tF="168" " Delimiters, SpecialChar
