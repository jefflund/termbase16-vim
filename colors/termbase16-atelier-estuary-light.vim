...
highlight clear
syntax reset
let g:colors_name="termbase16-atelier-estuary-light"
...
let s:t9="130" " Numbers, Booleans, Constants
let s:tA="136" " Classes, Labels
let s:tB="100" " Strings, Diff Add
let s:tC="071" " Escapes, RegExp
let s:tD="071" " Function, Include, Directory
let s:tE="066" " Keywords, Storage, Diff Change
