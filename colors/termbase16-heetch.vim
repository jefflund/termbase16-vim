...
let s:tA="096" " Classes, Labels
let s:tB="132" " Strings, Diff Add
let s:tC="197" " Escapes, RegExp
let s:tD="125" " Function, Include, Directory
let s:tE="089" " Keywords, Storage, Diff Change
let s:tF="053" " Delimiters, SpecialChar
