...
highlight clear
syntax reset
let g:colors_name="termbase16-cupertino"

" Color definitions
let s:t0="015" " Default Background
let s:t1="250" " Lighter Background (Status bars)
...
let s:t7="059" " Light Background (Rarely used)
let s:t8="160" " Debug, Identifiers, Diff Delete
let s:t9="172" " Numbers, Booleans, Constants
let s:tA="094" " Classes, Labels
let s:tB="028" " Strings, Diff Add
let s:tC="066" " Escapes, RegExp
let s:tD="021" " Function, Include, Directory
