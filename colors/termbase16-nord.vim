...
highlight clear
syntax reset
let g:colors_name="termbase16-nord"

" Color definitions
let s:t0="237" " Default Background
let s:t1="238" " Lighter Background (Status bars)
let s:t2="239" " Selection Background
let s:t3="240" " Comments, Invisibles
let s:t4="253" " Dark Foreground (Status bars)
let s:t5="255" " Default Foreground
let s:t6="255" " Light Foreground (Rarely used)
let s:t7="109" " Light Background (Rarely used)
let s:t8="110" " Debug, Identifiers, Diff Delete
let s:t9="109" " Numbers, Booleans, Constants
let s:tA="067" " Classes, Labels
let s:tB="131" " Strings, Diff Add
let s:tC="173" " Escapes, RegExp
let s:tD="186" " Function, Include, Directory
let s:tE="144" " Keywords, Storage, Diff Change
let s:tF="139" " Delimiters, SpecialChar
