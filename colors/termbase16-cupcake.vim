...
highlight clear
syntax reset
let g:colors_name="termbase16-cupcake"

" Color definitions
let s:t0="255" " Default Background
let s:t1="255" " Lighter Background (Status bars)
let s:t2="188" " Selection Background
let s:t3="250" " Comments, Invisibles
let s:t4="248" " Dark Foreground (Status bars)
let s:t5="245" " Default Foreground
let s:t6="242" " Light Foreground (Rarely used)
let s:t7="240" " Light Background (Rarely used)
let s:t8="174" " Debug, Identifiers, Diff Delete
let s:t9="180" " Numbers, Booleans, Constants
let s:tA="179" " Classes, Labels
...
let s:tF="144" " Delimiters, SpecialChar
