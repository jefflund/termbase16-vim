...
highlight clear
syntax reset
let g:colors_name="termbase16-one-light"

" Color definitions
let s:t0="015" " Default Background
let s:t1="255" " Lighter Background (Status bars)
let s:t2="254" " Selection Background
let s:t3="247" " Comments, Invisibles
let s:t4="242" " Dark Foreground (Status bars)
let s:t5="237" " Default Foreground
let s:t6="235" " Light Foreground (Rarely used)
let s:t7="232" " Light Background (Rarely used)
let s:t8="161" " Debug, Identifiers, Diff Delete
let s:t9="166" " Numbers, Booleans, Constants
let s:tA="136" " Classes, Labels
let s:tB="071" " Strings, Diff Add
let s:tC="031" " Escapes, RegExp
let s:tD="069" " Function, Include, Directory
let s:tE="005" " Keywords, Storage, Diff Change
let s:tF="094" " Delimiters, SpecialChar
