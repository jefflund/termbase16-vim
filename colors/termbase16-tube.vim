...
highlight clear
syntax reset
let g:colors_name="termbase16-tube"

" Color definitions
let s:t0="234" " Default Background
let s:t1="024" " Lighter Background (Status bars)
...
let s:t9="211" " Numbers, Booleans, Constants
...
let s:tE="089" " Keywords, Storage, Diff Change
