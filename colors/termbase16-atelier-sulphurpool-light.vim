...
highlight clear
syntax reset
let g:colors_name="termbase16-atelier-sulphurpool-light"

" Color definitions
let s:t0="015" " Default Background
let s:t1="254" " Lighter Background (Status bars)
let s:t2="247" " Selection Background
let s:t3="103" " Comments, Invisibles
let s:t4="060" " Dark Foreground (Status bars)
let s:t5="060" " Default Foreground
let s:t6="237" " Light Foreground (Rarely used)
let s:t7="236" " Light Background (Rarely used)
let s:t8="166" " Debug, Identifiers, Diff Delete
let s:t9="166" " Numbers, Booleans, Constants
let s:tA="137" " Classes, Labels
let s:tB="137" " Strings, Diff Add
let s:tC="038" " Escapes, RegExp
let s:tD="068" " Function, Include, Directory
let s:tE="068" " Keywords, Storage, Diff Change
let s:tF="132" " Delimiters, SpecialChar
