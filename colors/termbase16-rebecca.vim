...
highlight clear
syntax reset
let g:colors_name="termbase16-rebecca"

" Color definitions
let s:t0="236" " Default Background
let s:t1="060" " Lighter Background (Status bars)
let s:t2="238" " Selection Background
let s:t3="060" " Comments, Invisibles
let s:t4="146" " Dark Foreground (Status bars)
let s:t5="255" " Default Foreground
let s:t6="189" " Light Foreground (Rarely used)
let s:t7="008" " Light Background (Rarely used)
let s:t8="146" " Debug, Identifiers, Diff Delete
let s:t9="223" " Numbers, Booleans, Constants
let s:tA="141" " Classes, Labels
let s:tB="086" " Strings, Diff Add
let s:tC="110" " Escapes, RegExp
let s:tD="043" " Function, Include, Directory
let s:tE="111" " Keywords, Storage, Diff Change
let s:tF="212" " Delimiters, SpecialChar
