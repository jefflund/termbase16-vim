...
let s:t9="031" " Numbers, Booleans, Constants
let s:tA="097" " Classes, Labels
let s:tB="024" " Strings, Diff Add
let s:tC="024" " Escapes, RegExp
let s:tD="097" " Function, Include, Directory
let s:tE="125" " Keywords, Storage, Diff Change
let s:tF="236" " Delimiters, SpecialChar
