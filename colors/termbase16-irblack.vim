...
highlight clear
syntax reset
let g:colors_name="termbase16-irblack"
...
let s:t5="249" " Default Foreground
let s:t6="188" " Light Foreground (Rarely used)
let s:t7="015" " Light Background (Rarely used)
let s:t8="203" " Debug, Identifiers, Diff Delete
let s:t9="179" " Numbers, Booleans, Constants
let s:tA="229" " Classes, Labels
let s:tB="155" " Strings, Diff Add
let s:tC="189" " Escapes, RegExp
let s:tD="117" " Function, Include, Directory
let s:tE="207" " Keywords, Storage, Diff Change
let s:tF="137" " Delimiters, SpecialChar
