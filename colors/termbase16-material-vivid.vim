...
highlight clear
syntax reset
let g:colors_name="termbase16-material-vivid"
...
let s:tB="042" " Strings, Diff Add
let s:tC="039" " Escapes, RegExp
let s:tD="033" " Function, Include, Directory
let s:tE="057" " Keywords, Storage, Diff Change
