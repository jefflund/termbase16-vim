...
highlight clear
syntax reset
let g:colors_name="termbase16-ashes"
...
let s:t4="249" " Dark Foreground (Status bars)
let s:t5="252" " Default Foreground
let s:t6="254" " Light Foreground (Rarely used)
let s:t7="255" " Light Background (Rarely used)
let s:t8="180" " Debug, Identifiers, Diff Delete
let s:t9="186" " Numbers, Booleans, Constants
let s:tA="150" " Classes, Labels
let s:tB="115" " Strings, Diff Add
let s:tC="110" " Escapes, RegExp
let s:tD="140" " Function, Include, Directory
let s:tE="175" " Keywords, Storage, Diff Change
let s:tF="174" " Delimiters, SpecialChar
