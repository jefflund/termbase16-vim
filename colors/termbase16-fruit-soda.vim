...
let s:tB="010" " Strings, Diff Add
let s:tC="039" " Escapes, RegExp
let s:tD="026" " Function, Include, Directory
let s:tE="056" " Keywords, Storage, Diff Change
