...
highlight clear
syntax reset
let g:colors_name="termbase16-solarflare"

" Color definitions
let s:t0="235" " Default Background
let s:t1="236" " Lighter Background (Status bars)
let s:t2="242" " Selection Background
let s:t3="243" " Comments, Invisibles
let s:t4="246" " Dark Foreground (Status bars)
let s:t5="145" " Default Foreground
let s:t6="255" " Light Foreground (Rarely used)
...
let s:tA="178" " Classes, Labels
let s:tB="113" " Strings, Diff Add
let s:tC="079" " Escapes, RegExp
let s:tD="074" " Function, Include, Directory
let s:tE="134" " Keywords, Storage, Diff Change
