...
highlight clear
syntax reset
let g:colors_name="termbase16-summerfruit-light"

" Color definitions
let s:t0="015" " Default Background
let s:t1="254" " Lighter Background (Status bars)
let s:t2="252" " Selection Background
let s:t3="145" " Comments, Invisibles
let s:t4="000" " Dark Foreground (Status bars)
let s:t5="233" " Default Foreground
let s:t6="233" " Light Foreground (Rarely used)
let s:t7="234" " Light Background (Rarely used)
let s:t8="198" " Debug, Identifiers, Diff Delete
let s:t9="208" " Numbers, Booleans, Constants
let s:tA="142" " Classes, Labels
