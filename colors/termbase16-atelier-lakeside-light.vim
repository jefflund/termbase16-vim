...
highlight clear
syntax reset
let g:colors_name="termbase16-atelier-lakeside-light"

" Color definitions
let s:t0="255" " Default Background
let s:t1="153" " Lighter Background (Status bars)
let s:t2="109" " Selection Background
let s:t3="067" " Comments, Invisibles
