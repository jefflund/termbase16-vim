...
highlight clear
syntax reset
let g:colors_name="termbase16-gruvbox-dark-medium"

" Color definitions
let s:t0="235" " Default Background
let s:t1="237" " Lighter Background (Status bars)
let s:t2="239" " Selection Background
let s:t3="059" " Comments, Invisibles
let s:t4="144" " Dark Foreground (Status bars)
let s:t5="187" " Default Foreground
let s:t6="187" " Light Foreground (Rarely used)
let s:t7="230" " Light Background (Rarely used)
let s:t8="203" " Debug, Identifiers, Diff Delete
let s:t9="208" " Numbers, Booleans, Constants
let s:tA="214" " Classes, Labels
let s:tB="142" " Strings, Diff Add
let s:tC="108" " Escapes, RegExp
let s:tD="108" " Function, Include, Directory
let s:tE="174" " Keywords, Storage, Diff Change
