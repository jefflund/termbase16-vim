...
highlight clear
syntax reset
let g:colors_name="termbase16-pico"

" Color definitions
let s:t0="000" " Default Background
let s:t1="236" " Lighter Background (Status bars)
let s:t2="089" " Selection Background
let s:t3="029" " Comments, Invisibles
let s:t4="131" " Dark Foreground (Status bars)
let s:t5="240" " Default Foreground
let s:t6="251" " Light Foreground (Rarely used)
let s:t7="255" " Light Background (Rarely used)
let s:t8="197" " Debug, Identifiers, Diff Delete
let s:t9="214" " Numbers, Booleans, Constants
let s:tA="226" " Classes, Labels
let s:tB="041" " Strings, Diff Add
let s:tC="039" " Escapes, RegExp
let s:tD="103" " Function, Include, Directory
let s:tE="211" " Keywords, Storage, Diff Change
let s:tF="223" " Delimiters, SpecialChar
