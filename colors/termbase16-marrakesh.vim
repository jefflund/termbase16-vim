...
highlight clear
syntax reset
let g:colors_name="termbase16-marrakesh"

" Color definitions
let s:t0="233" " Default Background
let s:t1="234" " Lighter Background (Status bars)
let s:t2="058" " Selection Background
let s:t3="058" " Comments, Invisibles
let s:t4="101" " Dark Foreground (Status bars)
let s:t5="101" " Default Foreground
let s:t6="180" " Light Foreground (Rarely used)
...
let s:tB="029" " Strings, Diff Add
let s:tC="107" " Escapes, RegExp
