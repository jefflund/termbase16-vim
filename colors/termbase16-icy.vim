...
highlight clear
syntax reset
let g:colors_name="termbase16-icy"

" Color definitions
let s:t0="233" " Default Background
let s:t1="233" " Lighter Background (Status bars)
let s:t2="234" " Selection Background
let s:t3="235" " Comments, Invisibles
let s:t4="023" " Dark Foreground (Status bars)
let s:t5="023" " Default Foreground
let s:t6="030" " Light Foreground (Rarely used)
let s:t7="006" " Light Background (Rarely used)
let s:t8="038" " Debug, Identifiers, Diff Delete
let s:t9="153" " Numbers, Booleans, Constants
let s:tA="116" " Classes, Labels
let s:tB="080" " Strings, Diff Add
let s:tC="044" " Escapes, RegExp
let s:tD="038" " Function, Include, Directory
let s:tE="037" " Keywords, Storage, Diff Change
let s:tF="031" " Delimiters, SpecialChar
