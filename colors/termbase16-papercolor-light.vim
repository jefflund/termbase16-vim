...
highlight clear
syntax reset
let g:colors_name="termbase16-papercolor-light"

" Color definitions
let s:t0="255" " Default Background
let s:t1="124" " Lighter Background (Status bars)
let s:t2="028" " Selection Background
let s:t3="064" " Comments, Invisibles
let s:t4="031" " Dark Foreground (Status bars)
let s:t5="102" " Default Foreground
let s:t6="024" " Light Foreground (Rarely used)
let s:t7="238" " Light Background (Rarely used)
let s:t8="250" " Debug, Identifiers, Diff Delete
let s:t9="160" " Numbers, Booleans, Constants
let s:tA="162" " Classes, Labels
let s:tB="091" " Strings, Diff Add
let s:tC="166" " Escapes, RegExp
let s:tD="166" " Function, Include, Directory
let s:tE="025" " Keywords, Storage, Diff Change
let s:tF="024" " Delimiters, SpecialChar
