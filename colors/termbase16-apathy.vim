...
highlight clear
syntax reset
let g:colors_name="termbase16-apathy"

" Color definitions
let s:t0="233" " Default Background
let s:t1="235" " Lighter Background (Status bars)
let s:t2="023" " Selection Background
let s:t3="023" " Comments, Invisibles
let s:t4="072" " Dark Foreground (Status bars)
let s:t5="109" " Default Foreground
let s:t6="152" " Light Foreground (Rarely used)
let s:t7="254" " Light Background (Rarely used)
let s:t8="066" " Debug, Identifiers, Diff Delete
let s:t9="066" " Numbers, Booleans, Constants
let s:tA="060" " Classes, Labels
let s:tB="096" " Strings, Diff Add
let s:tC="095" " Escapes, RegExp
let s:tD="101" " Function, Include, Directory
let s:tE="065" " Keywords, Storage, Diff Change
let s:tF="065" " Delimiters, SpecialChar
