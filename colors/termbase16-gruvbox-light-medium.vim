...
highlight clear
syntax reset
let g:colors_name="termbase16-gruvbox-light-medium"

" Color definitions
let s:t0="230" " Default Background
let s:t1="187" " Lighter Background (Status bars)
let s:t2="187" " Selection Background
let s:t3="144" " Comments, Invisibles
let s:t4="059" " Dark Foreground (Status bars)
let s:t5="239" " Default Foreground
let s:t6="237" " Light Foreground (Rarely used)
let s:t7="235" " Light Background (Rarely used)
let s:t8="001" " Debug, Identifiers, Diff Delete
let s:t9="003" " Numbers, Booleans, Constants
let s:tA="136" " Classes, Labels
let s:tB="100" " Strings, Diff Add
let s:tC="065" " Escapes, RegExp
let s:tD="024" " Function, Include, Directory
let s:tE="095" " Keywords, Storage, Diff Change
let s:tF="166" " Delimiters, SpecialChar
