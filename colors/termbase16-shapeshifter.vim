...
highlight clear
syntax reset
let g:colors_name="termbase16-shapeshifter"

" Color definitions
let s:t0="015" " Default Background
let s:t1="254" " Lighter Background (Status bars)
let s:t2="007" " Selection Background
let s:t3="008" " Comments, Invisibles
let s:t4="236" " Dark Foreground (Status bars)
let s:t5="234" " Default Foreground
let s:t6="000" " Light Foreground (Rarely used)
let s:t7="000" " Light Background (Rarely used)
let s:t8="160" " Debug, Identifiers, Diff Delete
let s:t9="173" " Numbers, Booleans, Constants
let s:tA="184" " Classes, Labels
let s:tB="041" " Strings, Diff Add
let s:tC="050" " Escapes, RegExp
let s:tD="012" " Function, Include, Directory
let s:tE="212" " Keywords, Storage, Diff Change
let s:tF="239" " Delimiters, SpecialChar
