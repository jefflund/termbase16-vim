...
highlight clear
syntax reset
let g:colors_name="termbase16-codeschool"

" Color definitions
let s:t0="236" " Default Background
let s:t1="237" " Lighter Background (Status bars)
let s:t2="236" " Selection Background
let s:t3="238" " Comments, Invisibles
let s:t4="102" " Dark Foreground (Status bars)
let s:t5="248" " Default Foreground
let s:t6="151" " Light Foreground (Rarely used)
let s:t7="153" " Light Background (Rarely used)
let s:t8="024" " Debug, Identifiers, Diff Delete
let s:t9="064" " Numbers, Booleans, Constants
let s:tA="003" " Classes, Labels
let s:tB="030" " Strings, Diff Add
let s:tC="003" " Escapes, RegExp
let s:tD="060" " Function, Include, Directory
let s:tE="172" " Keywords, Storage, Diff Change
