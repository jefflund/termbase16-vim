...
highlight clear
syntax reset
let g:colors_name="termbase16-papercolor-dark"

" Color definitions
let s:t0="234" " Default Background
let s:t1="125" " Lighter Background (Status bars)
let s:t2="070" " Selection Background
let s:t3="179" " Comments, Invisibles
let s:t4="074" " Dark Foreground (Status bars)
let s:t5="244" " Default Foreground
let s:t6="173" " Light Foreground (Rarely used)
let s:t7="252" " Light Background (Rarely used)
let s:t8="240" " Debug, Identifiers, Diff Delete
let s:t9="071" " Numbers, Booleans, Constants
let s:tA="148" " Classes, Labels
let s:tB="140" " Strings, Diff Add
let s:tC="214" " Escapes, RegExp
let s:tD="205" " Function, Include, Directory
let s:tE="037" " Keywords, Storage, Diff Change
let s:tF="066" " Delimiters, SpecialChar
