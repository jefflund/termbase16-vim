...
highlight clear
syntax reset
let g:colors_name="termbase16-circus"

" Color definitions
let s:t0="234" " Default Background
let s:t1="234" " Lighter Background (Status bars)
let s:t2="236" " Selection Background
let s:t3="059" " Comments, Invisibles
let s:t4="239" " Dark Foreground (Status bars)
let s:t5="248" " Default Foreground
let s:t6="244" " Light Foreground (Rarely used)
let s:t7="015" " Light Background (Rarely used)
let s:t8="168" " Debug, Identifiers, Diff Delete
let s:t9="073" " Numbers, Booleans, Constants
let s:tA="143" " Classes, Labels
let s:tB="108" " Strings, Diff Add
let s:tC="073" " Escapes, RegExp
let s:tD="074" " Function, Include, Directory
let s:tE="140" " Keywords, Storage, Diff Change
let s:tF="140" " Delimiters, SpecialChar
