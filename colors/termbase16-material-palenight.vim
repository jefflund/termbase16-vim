...
highlight clear
syntax reset
let g:colors_name="termbase16-material-palenight"

" Color definitions
let s:t0="236" " Default Background
let s:t1="239" " Lighter Background (Status bars)
let s:t2="237" " Selection Background
let s:t3="060" " Comments, Invisibles
let s:t4="103" " Dark Foreground (Status bars)
let s:t5="110" " Default Foreground
let s:t6="110" " Light Foreground (Rarely used)
