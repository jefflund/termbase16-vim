...
highlight clear
syntax reset
let g:colors_name="termbase16-heetch-light"

" Color definitions
let s:t0="015" " Default Background
let s:t1="237" " Lighter Background (Status bars)
let s:t2="096" " Selection Background
let s:t3="247" " Comments, Invisibles
let s:t4="253" " Dark Foreground (Status bars)
let s:t5="240" " Default Foreground
let s:t6="053" " Light Foreground (Rarely used)
let s:t7="234" " Light Background (Rarely used)
let s:t8="044" " Debug, Identifiers, Diff Delete
let s:t9="250" " Numbers, Booleans, Constants
let s:tA="073" " Classes, Labels
let s:tB="197" " Strings, Diff Add
let s:tC="132" " Escapes, RegExp
let s:tD="014" " Function, Include, Directory
let s:tE="125" " Keywords, Storage, Diff Change
let s:tF="253" " Delimiters, SpecialChar
