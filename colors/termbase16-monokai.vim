...
highlight clear
syntax reset
let g:colors_name="termbase16-monokai"
...
let s:tA="216" " Classes, Labels
let s:tB="148" " Strings, Diff Add
let s:tC="158" " Escapes, RegExp
let s:tD="081" " Function, Include, Directory
let s:tE="141" " Keywords, Storage, Diff Change
