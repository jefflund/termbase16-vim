...
highlight clear
syntax reset
let g:colors_name="termbase16-unikitty-light"

" Color definitions
let s:t0="015" " Default Background
let s:t1="254" " Lighter Background (Status bars)
let s:t2="251" " Selection Background
let s:t3="248" " Comments, Invisibles
let s:t4="245" " Dark Foreground (Status bars)
let s:t5="242" " Default Foreground
let s:t6="239" " Light Foreground (Rarely used)
let s:t7="236" " Light Background (Rarely used)
let s:t8="162" " Debug, Identifiers, Diff Delete
let s:t9="166" " Numbers, Booleans, Constants
let s:tA="172" " Classes, Labels
let s:tB="036" " Strings, Diff Add
let s:tC="032" " Escapes, RegExp
let s:tD="099" " Function, Include, Directory
let s:tE="128" " Keywords, Storage, Diff Change
let s:tF="164" " Delimiters, SpecialChar
