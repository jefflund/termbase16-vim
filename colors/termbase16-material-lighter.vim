...
highlight clear
syntax reset
let g:colors_name="termbase16-material-lighter"

" Color definitions
let s:t0="015" " Default Background
let s:t1="255" " Lighter Background (Status bars)
let s:t2="254" " Selection Background
let s:t3="188" " Comments, Invisibles
let s:t4="103" " Dark Foreground (Status bars)
let s:t5="116" " Default Foreground
let s:t6="116" " Light Foreground (Rarely used)
let s:t7="015" " Light Background (Rarely used)
let s:t8="203" " Debug, Identifiers, Diff Delete
let s:t9="203" " Numbers, Booleans, Constants
let s:tA="214" " Classes, Labels
let s:tB="107" " Strings, Diff Add
let s:tC="073" " Escapes, RegExp
let s:tD="067" " Function, Include, Directory
let s:tE="099" " Keywords, Storage, Diff Change
let s:tF="167" " Delimiters, SpecialChar
