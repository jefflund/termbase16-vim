...
let s:t9="182" " Numbers, Booleans, Constants
let s:tA="226" " Classes, Labels
let s:tB="035" " Strings, Diff Add
let s:tC="153" " Escapes, RegExp
let s:tD="038" " Function, Include, Directory
let s:tE="132" " Keywords, Storage, Diff Change
let s:tF="179" " Delimiters, SpecialChar
