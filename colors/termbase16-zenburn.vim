...
highlight clear
syntax reset
let g:colors_name="termbase16-zenburn"

" Color definitions
let s:t0="237" " Default Background
let s:t1="238" " Lighter Background (Status bars)
let s:t2="059" " Selection Background
let s:t3="239" " Comments, Invisibles
let s:t4="244" " Dark Foreground (Status bars)
let s:t5="188" " Default Foreground
let s:t6="250" " Light Foreground (Rarely used)
let s:t7="015" " Light Background (Rarely used)
let s:t8="181" " Debug, Identifiers, Diff Delete
let s:t9="180" " Numbers, Booleans, Constants
let s:tA="187" " Classes, Labels
let s:tB="065" " Strings, Diff Add
let s:tC="116" " Escapes, RegExp
let s:tD="109" " Function, Include, Directory
let s:tE="175" " Keywords, Storage, Diff Change
let s:tF="000" " Delimiters, SpecialChar
