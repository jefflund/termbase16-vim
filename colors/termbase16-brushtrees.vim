...
highlight clear
syntax reset
let g:colors_name="termbase16-brushtrees"

" Color definitions
let s:t0="255" " Default Background
let s:t1="188" " Lighter Background (Status bars)
let s:t2="250" " Selection Background
let s:t3="109" " Comments, Invisibles
let s:t4="246" " Dark Foreground (Status bars)
let s:t5="066" " Default Foreground
let s:t6="060" " Light Foreground (Rarely used)
let s:t7="240" " Light Background (Rarely used)
let s:t8="138" " Debug, Identifiers, Diff Delete
let s:t9="181" " Numbers, Booleans, Constants
let s:tA="144" " Classes, Labels
...
let s:tF="248" " Delimiters, SpecialChar
