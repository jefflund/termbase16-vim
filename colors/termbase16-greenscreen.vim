...
highlight clear
syntax reset
let g:colors_name="termbase16-greenscreen"

" Color definitions
let s:t0="232" " Default Background
let s:t1="233" " Lighter Background (Status bars)
let s:t2="022" " Selection Background
let s:t3="028" " Comments, Invisibles
let s:t4="002" " Dark Foreground (Status bars)
let s:t5="034" " Default Foreground
let s:t6="040" " Light Foreground (Rarely used)
let s:t7="046" " Light Background (Rarely used)
let s:t8="028" " Debug, Identifiers, Diff Delete
let s:t9="002" " Numbers, Booleans, Constants
let s:tA="028" " Classes, Labels
let s:tB="034" " Strings, Diff Add
let s:tC="022" " Escapes, RegExp
let s:tD="002" " Function, Include, Directory
let s:tE="034" " Keywords, Storage, Diff Change
let s:tF="022" " Delimiters, SpecialChar
