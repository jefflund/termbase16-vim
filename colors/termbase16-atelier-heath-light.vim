...
highlight clear
syntax reset
let g:colors_name="termbase16-atelier-heath-light"

" Color definitions
let s:t0="255" " Default Background
let s:t1="252" " Lighter Background (Status bars)
let s:t2="248" " Selection Background
...
let s:tB="101" " Strings, Diff Add
let s:tC="030" " Escapes, RegExp
let s:tD="063" " Function, Include, Directory
let s:tE="097" " Keywords, Storage, Diff Change
let s:tF="170" " Delimiters, SpecialChar
