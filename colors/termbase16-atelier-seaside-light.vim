...
highlight clear
syntax reset
let g:colors_name="termbase16-atelier-seaside-light"

" Color definitions
let s:t0="015" " Default Background
let s:t1="253" " Lighter Background (Status bars)
let s:t2="108" " Selection Background
let s:t3="245" " Comments, Invisibles
let s:t4="065" " Dark Foreground (Status bars)
let s:t5="241" " Default Foreground
...
let s:t9="094" " Numbers, Booleans, Constants
let s:tA="100" " Classes, Labels
let s:tB="002" " Strings, Diff Add
let s:tC="031" " Escapes, RegExp
let s:tD="012" " Function, Include, Directory
let s:tE="129" " Keywords, Storage, Diff Change
let s:tF="163" " Delimiters, SpecialChar
