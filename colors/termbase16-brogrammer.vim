...
highlight clear
syntax reset
let g:colors_name="termbase16-brogrammer"

" Color definitions
let s:t0="234" " Default Background
let s:t1="196" " Lighter Background (Status bars)
let s:t2="041" " Selection Background
let s:t3="214" " Comments, Invisibles
let s:t4="032" " Dark Foreground (Status bars)
let s:t5="061" " Default Foreground
let s:t6="032" " Light Foreground (Rarely used)
let s:t7="253" " Light Background (Rarely used)
let s:t8="253" " Debug, Identifiers, Diff Delete
let s:t9="166" " Numbers, Booleans, Constants
let s:tA="041" " Classes, Labels
let s:tB="214" " Strings, Diff Add
let s:tC="032" " Escapes, RegExp
let s:tD="061" " Function, Include, Directory
let s:tE="032" " Keywords, Storage, Diff Change
let s:tF="015" " Delimiters, SpecialChar
