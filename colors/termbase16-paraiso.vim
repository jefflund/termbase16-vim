...
highlight clear
syntax reset
let g:colors_name="termbase16-paraiso"

" Color definitions
let s:t0="235" " Default Background
let s:t1="237" " Lighter Background (Status bars)
let s:t2="238" " Selection Background
let s:t3="243" " Comments, Invisibles
let s:t4="102" " Dark Foreground (Status bars)
let s:t5="247" " Default Foreground
let s:t6="249" " Light Foreground (Rarely used)
let s:t7="254" " Light Background (Rarely used)
let s:t8="203" " Debug, Identifiers, Diff Delete
let s:t9="208" " Numbers, Booleans, Constants
let s:tA="220" " Classes, Labels
let s:tB="072" " Strings, Diff Add
let s:tC="079" " Escapes, RegExp
let s:tD="039" " Function, Include, Directory
let s:tE="097" " Keywords, Storage, Diff Change
let s:tF="169" " Delimiters, SpecialChar
