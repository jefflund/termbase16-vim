...
highlight clear
syntax reset
let g:colors_name="termbase16-isotope"
...
let s:tA="198" " Classes, Labels
let s:tB="082" " Strings, Diff Add
let s:tC="051" " Escapes, RegExp
let s:tD="027" " Function, Include, Directory
let s:tE="165" " Keywords, Storage, Diff Change
let s:tF="057" " Delimiters, SpecialChar
