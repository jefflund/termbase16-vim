...
highlight clear
syntax reset
let g:colors_name="termbase16-dracula"
...
let s:t4="080" " Dark Foreground (Status bars)
let s:t5="255" " Default Foreground
let s:t6="255" " Light Foreground (Rarely used)
let s:t7="015" " Light Background (Rarely used)
let s:t8="169" " Debug, Identifiers, Diff Delete
let s:t9="134" " Numbers, Booleans, Constants
let s:tA="047" " Classes, Labels
let s:tB="192" " Strings, Diff Add
let s:tC="158" " Escapes, RegExp
let s:tD="080" " Function, Include, Directory
let s:tE="134" " Keywords, Storage, Diff Change
let s:tF="047" " Delimiters, SpecialChar
