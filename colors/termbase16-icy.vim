...
let s:t8="031" " Debug, Identifiers, Diff Delete
let s:t9="037" " Numbers, Booleans, Constants
let s:tA="038" " Classes, Labels
let s:tB="044" " Strings, Diff Add
let s:tC="080" " Escapes, RegExp
let s:tD="116" " Function, Include, Directory
let s:tE="153" " Keywords, Storage, Diff Change
let s:tF="195" " Delimiters, SpecialChar
