...
highlight clear
syntax reset
let g:colors_name="termbase16-outrun-dark"
...
let s:t5="189" " Default Foreground
...
let s:tB="084" " Strings, Diff Add
let s:tC="051" " Escapes, RegExp
let s:tD="075" " Function, Include, Directory
let s:tE="198" " Keywords, Storage, Diff Change
let s:tF="201" " Delimiters, SpecialChar
