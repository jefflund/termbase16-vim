...
highlight clear
syntax reset
let g:colors_name="termbase16-atelier-cave-light"

" Color definitions
let s:t0="255" " Default Background
let s:t1="254" " Lighter Background (Status bars)
let s:t2="245" " Selection Background
let s:t3="244" " Comments, Invisibles
let s:t4="241" " Dark Foreground (Status bars)
let s:t5="240" " Default Foreground
let s:t6="235" " Light Foreground (Rarely used)
let s:t7="234" " Light Background (Rarely used)
let s:t8="132" " Debug, Identifiers, Diff Delete
let s:t9="131" " Numbers, Booleans, Constants
let s:tA="131" " Classes, Labels
let s:tB="030" " Strings, Diff Add
let s:tC="068" " Escapes, RegExp
let s:tD="062" " Function, Include, Directory
let s:tE="098" " Keywords, Storage, Diff Change
let s:tF="133" " Delimiters, SpecialChar
