...
highlight clear
syntax reset
let g:colors_name="termbase16-chalk"
...
let s:t8="217" " Debug, Identifiers, Diff Delete
let s:t9="216" " Numbers, Booleans, Constants
let s:tA="179" " Classes, Labels
let s:tB="143" " Strings, Diff Add
let s:tC="043" " Escapes, RegExp
let s:tD="075" " Function, Include, Directory
let s:tE="183" " Keywords, Storage, Diff Change
let s:tF="180" " Delimiters, SpecialChar
