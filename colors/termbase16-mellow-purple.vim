...
highlight clear
syntax reset
let g:colors_name="termbase16-mellow-purple"

" Color definitions
let s:t0="233" " Default Background
let s:t1="234" " Lighter Background (Status bars)
let s:t2="053" " Selection Background
let s:t3="053" " Comments, Invisibles
let s:t4="096" " Dark Foreground (Status bars)
let s:t5="015" " Default Foreground
let s:t6="015" " Light Foreground (Rarely used)
let s:t7="219" " Light Background (Rarely used)
let s:t8="044" " Debug, Identifiers, Diff Delete
let s:t9="005" " Numbers, Booleans, Constants
let s:tA="098" " Classes, Labels
let s:tB="040" " Strings, Diff Add
let s:tC="127" " Escapes, RegExp
let s:tD="053" " Function, Include, Directory
let s:tE="103" " Keywords, Storage, Diff Change
let s:tF="063" " Delimiters, SpecialChar
