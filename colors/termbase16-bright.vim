...
highlight clear
syntax reset
let g:colors_name="termbase16-bright"
...
let s:t4="252" " Dark Foreground (Status bars)
let s:t5="254" " Default Foreground
let s:t6="255" " Light Foreground (Rarely used)
let s:t7="015" " Light Background (Rarely used)
let s:t8="196" " Debug, Identifiers, Diff Delete
let s:t9="202" " Numbers, Booleans, Constants
let s:tA="215" " Classes, Labels
let s:tB="149" " Strings, Diff Add
let s:tC="115" " Escapes, RegExp
let s:tD="074" " Function, Include, Directory
let s:tE="175" " Keywords, Storage, Diff Change
