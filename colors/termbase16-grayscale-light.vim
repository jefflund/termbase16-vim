...
highlight clear
syntax reset
let g:colors_name="termbase16-grayscale-light"

" Color definitions
let s:t0="015" " Default Background
let s:t1="254" " Lighter Background (Status bars)
let s:t2="250" " Selection Background
let s:t3="007" " Comments, Invisibles
let s:t4="008" " Dark Foreground (Status bars)
let s:t5="238" " Default Foreground
let s:t6="235" " Light Foreground (Rarely used)
let s:t7="233" " Light Background (Rarely used)
let s:t8="244" " Debug, Identifiers, Diff Delete
let s:t9="246" " Numbers, Booleans, Constants
let s:tA="247" " Classes, Labels
let s:tB="245" " Strings, Diff Add
let s:tC="102" " Escapes, RegExp
let s:tD="242" " Function, Include, Directory
let s:tE="243" " Keywords, Storage, Diff Change
let s:tF="059" " Delimiters, SpecialChar
