...
highlight clear
syntax reset
let g:colors_name="termbase16-material-darker"

" Color definitions
let s:t0="234" " Default Background
let s:t1="236" " Lighter Background (Status bars)
let s:t2="236" " Selection Background
let s:t3="239" " Comments, Invisibles
let s:t4="152" " Dark Foreground (Status bars)
let s:t5="015" " Default Foreground
let s:t6="015" " Light Foreground (Rarely used)
let s:t7="015" " Light Background (Rarely used)
let s:t8="204" " Debug, Identifiers, Diff Delete
let s:t9="209" " Numbers, Booleans, Constants
let s:tA="221" " Classes, Labels
let s:tB="150" " Strings, Diff Add
let s:tC="117" " Escapes, RegExp
let s:tD="111" " Function, Include, Directory
let s:tE="176" " Keywords, Storage, Diff Change
let s:tF="203" " Delimiters, SpecialChar
