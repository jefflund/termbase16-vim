...
highlight clear
syntax reset
let g:colors_name="termbase16-harmonic-light"

" Color definitions
let s:t0="015" " Default Background
let s:t1="255" " Lighter Background (Status bars)
let s:t2="188" " Selection Background
let s:t3="146" " Comments, Invisibles
...
let s:t8="137" " Debug, Identifiers, Diff Delete
let s:t9="143" " Numbers, Booleans, Constants
let s:tA="107" " Classes, Labels
let s:tB="072" " Strings, Diff Add
let s:tC="067" " Escapes, RegExp
let s:tD="097" " Function, Include, Directory
let s:tE="132" " Keywords, Storage, Diff Change
