...
highlight clear
syntax reset
let g:colors_name="termbase16-darktooth"
...
let s:t5="138" " Default Foreground
let s:t6="187" " Light Foreground (Rarely used)
let s:t7="229" " Light Background (Rarely used)
