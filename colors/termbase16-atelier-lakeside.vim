...
highlight clear
syntax reset
let g:colors_name="termbase16-atelier-lakeside"

" Color definitions
let s:t0="234" " Default Background
let s:t1="235" " Lighter Background (Status bars)
let s:t2="060" " Selection Background
let s:t3="066" " Comments, Invisibles
let s:t4="067" " Dark Foreground (Status bars)
let s:t5="109" " Default Foreground
let s:t6="153" " Light Foreground (Rarely used)
let s:t7="255" " Light Background (Rarely used)
let s:t8="161" " Debug, Identifiers, Diff Delete
let s:t9="094" " Numbers, Booleans, Constants
let s:tA="100" " Classes, Labels
let s:tB="065" " Strings, Diff Add
let s:tC="029" " Escapes, RegExp
let s:tD="031" " Function, Include, Directory
let s:tE="061" " Keywords, Storage, Diff Change
let s:tF="128" " Delimiters, SpecialChar
