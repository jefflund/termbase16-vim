...
highlight clear
syntax reset
let g:colors_name="termbase16-embers"
...
let s:t7="188" " Light Background (Rarely used)
let s:t8="095" " Debug, Identifiers, Diff Delete
let s:t9="101" " Numbers, Booleans, Constants
let s:tA="065" " Classes, Labels
let s:tB="065" " Strings, Diff Add
let s:tC="060" " Escapes, RegExp
let s:tD="060" " Function, Include, Directory
